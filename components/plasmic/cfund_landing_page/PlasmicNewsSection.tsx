  ...
  return (
    ...
    >
        ...
        {news.map(item => (
          ...
          >
              <NewsCard
                ...
                date={item.date}
                newsImage={(item._embedded["wp:featuredmedia"] && item._embedded["wp:featuredmedia"].length) ?item._embedded["wp:featuredmedia"][0]?.media_details?.sizes?.medium?.source_url:null}
                url={'https://blog.cfund.me/?p='+item.id}
      ...
      <p.PlasmicLink
        ...
        component={Link}
        href={"https://blog.cfund.me/" as const}
        target="_blank"
        platform={"nextjs"}
      >
        {"See All News"}
