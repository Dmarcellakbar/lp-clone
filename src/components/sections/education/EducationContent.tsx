...
import imgCase1 from "../../../assets/image/cfund/new-assets/education-content-1.png";
import imgCase2 from "../../../assets/image/cfund/new-assets/education-content-2.png";
        ...
        <Container>
          <Row className="justify-content-center">
            ...
            >
              <CaseCard
                img={imgCase1}
                meta={`Crypto Research`}
                title="[Crypto Market Outlook June 2021] Altcoin Potential Trade Setups."
              >
                Several setups on altcoin shall be presented. The setups will focus on intraday and daily movement for upcoming next week.
              </CaseCard>
            </Col>
            <Col
              lg="6"
            ...
            >
              <CaseCard
                ...
                img={imgCase2}
                meta={`Crypto Research`}
                title="OKExChain: A New and Exciting De-Fi."
              >
